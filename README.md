...
[IBM COBOL Compiler Family](https://www.ibm.com/products/cobol-compiler-family) — IBM's suite of COBOL compilers for z/OS that help organizations leverage and modernize existing applications, with tools for optimizing performance, enhancing existing programs, and extending them to new technologies. *COBOL relevance: The dominant compiler for production mainframe COBOL workloads running on IBM z/OS systems.*
...
[Tiny COBOL](https://tiny-cobol.sourceforge.net/) — An open-source COBOL compiler targeting COBOL 85 standards, running on FreeBSD, Linux, and Windows via MinGW and building on the GCC backend. *COBOL relevance: A lightweight, standards-focused alternative compiler useful for understanding compiler internals or running COBOL 85 programs in lightweight environments.*

[Rocket® COBOL (Rocket Software)](https://www.rocketsoftware.com/en-us/products/cobol) — Rocket® COBOL is a commercial compiler and runtime that enables modernization of COBOL applications across Windows, UNIX, Linux, .NET, JVM, cloud, containers, and microservices, with GenAI-assisted development tools to help teams extend and future-proof their COBOL codebases. *COBOL relevance: Offers enterprise-supported COBOL runtimes and tooling for organizations maintaining large COBOL codebases on distributed platforms.*
...
[Rocket Software - Learn COBOL in 1 Day Course](https://www.rocketsoftware.com/en-us/learn-cobol) — A free certification program from Rocket Software featuring instructor-led videos, hands-on tutorials, and the Rocket® COBOL development tools; completing the program earns a Rocket® COBOL Fundamentals certificate. *COBOL relevance: Rocket Software is a major enterprise COBOL vendor, making their free introductory certification a practical starting point for developers entering the mainframe ecosystem.*
...
[Mainframe: The Complete COBOL Course From Beginner To Expert (Udemy)](https://www.udemy.com/course/mainframe-the-complete-cobol-course-from-beginner-to-expert/) — The top-rated and bestselling COBOL course on Udemy (4.6/5 from 5,500+ ratings, 24,000+ students), covering all four COBOL divisions from scratch to advanced topics with hands-on coding, TSO/ISPF basics, and JCL fundamentals. *COBOL relevance: The most popular structured COBOL course on Udemy, widely used by developers targeting enterprise mainframe roles.*

[Introduction to COBOL (Udemy)](https://www.udemy.com/course/cobol-course/) — A Udemy course targeting developers new to COBOL, covering the fundamentals of the language and emphasizing its continued relevance to banking, finance, and large enterprise systems. *COBOL relevance: Entry-level COBOL courses on Udemy are widely used by self-taught developers breaking into legacy system maintenance roles.*

[Learn COBOL Super Fast - Fundamentals In Under 2 Hours (Udemy)](https://www.udemy.com/course/learn-cobol-super-fast/) — A concise Udemy course covering COBOL fundamentals in under two hours, framed around the language's continued dominance — processing $3 trillion in daily commerce and 95% of ATM transactions — to motivate learners through the material. *COBOL relevance: A concise crash course for developers who need a quick working understanding of COBOL syntax before diving into a legacy codebase.*

[Mainframe - COBOL DB2 - Basic to Advance Level (Udemy)](https://www.udemy.com/course/mainframe-cobol-db2-basic-to-advance-level/) — A practical, instructor-led Udemy course teaching COBOL and IBM DB2 together through real-world mainframe scenarios, progressing from basics to advanced topics in a classroom-style format. *COBOL relevance: DB2 is the primary database technology used alongside COBOL in mainframe applications, making combined COBOL/DB2 training essential for enterprise developers.*

[Learn Introductory Programming With COBOL (Udemy)](https://www.udemy.com/course/learn-introductory-programming-with-cobol/) — A Udemy course that teaches core programming concepts — the same fundamentals found in introductory Python or C courses — using COBOL as the implementation language, taught by an instructor with experience teaching intro programming across multiple languages. *COBOL relevance: Suitable for complete beginners who want to learn programming fundamentals while simultaneously gaining a marketable legacy-language skill.*
...
[What is a mainframe?](https://www.ibm.com/think/topics/mainframe) — IBM's technical overview defining mainframe computers as systems capable of processing billions of transactions in real time with built-in security and reliability, covering their architecture and continued central role in enterprise computing. *COBOL relevance: Mainframes are the primary runtime environment for the vast majority of production COBOL code, making this essential background for any COBOL developer.*

[What is COBOL?](https://www.ibm.com/think/topics/cobol) — IBM's overview of COBOL, defining it as a high-level, English-like compiled programming language developed specifically for business data processing, and covering its history, design goals, and continued role in enterprise systems. *COBOL relevance: A concise, authoritative starting point for anyone new to the language or needing to explain it to colleagues.*
...
[IBM Enterprise COBOL for z/OS Documentation Library](https://www.ibm.com/support/pages/enterprise-cobol-zos-documentation-library) — IBM's official documentation hub for Enterprise COBOL for z/OS aggregating product docs, white papers, announcement letters, and data sheets across all supported versions (3.1 through 6.5), with PDFs covering the Language Reference, Programming Guide, Migration Guide, Performance Tuning Guide, and more. *COBOL relevance: The definitive reference for IBM's flagship COBOL compiler, essential for any developer targeting z/OS production systems.*
